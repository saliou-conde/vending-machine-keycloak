...
* The original package name 'ch.akros.vending-machine' is invalid and this project uses 'ch.akros.vending_machine' instead.
...
docker run -p 9090:8080 -e KC_BOOTSTRAP_ADMIN_USERNAME=admin -e KC_BOOTSTRAP_ADMIN_PASSWORD=admin quay.io/keycloak/keycloak:26.0.7 start-dev
